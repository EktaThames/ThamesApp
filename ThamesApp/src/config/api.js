...
// NOTE: If using HTTP (not HTTPS) on a physical Android device, you MUST enable Cleartext Traffic.
// Since you are using Expo Managed Workflow (no android folder), add "usesCleartextTraffic": true to the "android" section of your app.json.
// export const API_URL = "http://13.48.13.62:3001";
